...
export const transactions: Transaction[] = [
  ...
  { id: '5', date: new Date(2024, 6, 7), description: 'Jantar com amigos', amount: 80, type: 'expense', category: 'Lazer' },
  ...
  { id: '10', date: new Date(2024, 6, 22), description: 'Ingressos de cinema', amount: 30, type: 'expense', category: 'Lazer' },
...
export const budgets: Budget[] = [
  ...
  { id: '4', category: 'Lazer', amount: 250, spent: spentByCategory['Lazer'] || 0 },
...
export const subscriptions: Subscription[] = [
    { id: '1', name: 'Netflix', amount: 39.90, billingCycle: 'mensal', nextPaymentDate: new Date(2024, 7, 10) },
    { id: '2', name: 'Spotify', amount: 21.90, billingCycle: 'mensal', nextPaymentDate: new Date(2024, 7, 15) },
    { id: '3', name: 'Amazon Prime', amount: 119, billingCycle: 'anual', nextPaymentDate: new Date(2025, 2, 20) },
    { id: '4', name: 'Academia', amount: 99.90, billingCycle: 'mensal', nextPaymentDate: new Date(2024, 7, 1) },
];
...
export const bills: Bill[] = [
    ...
    { id: '4', description: 'Fatura do Cartão de Crédito', amount: 850, dueDate: new Date(2024, 7, 8), type: 'payable', status: 'paid' },
]
